...
const Course = ({ route, navigation }) => {
  ...
  const handlesearch = (val)=>{
    setSearch(val)
    // Schedule.getTutors({search: val}).then(v => {
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.mainView}>
        <View style={{flexDirection:'row'}}> 
            <View>
                <Image style={{height:64,width:64}} source={require('../../assets/course.svg')}></Image>
            </View>
            <View>
                <Text style={styles.heading}>Discover Courses</Text>
                <TextInput
                    style={styles.input}
                    label="Email"
        ...
        <Text style={styles.heading}>LiveTutor has built the most quality, methodical and scientific courses in 
        the fields of life for those who are in need of improving their knowledge of the fields.</Text>
        <View style={{ flex: 1 }}>
      </View>
